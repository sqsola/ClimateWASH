...
for(entry in 1:nrow(countries)) {
  ...
  if (exists("spatial")) {
    ...
    codebook <- readRDS("~/data-mdavis65/steven_sola/0_Scripts/ClimateWASH/Aim 2/codebook.rds")
  ...
  full <- full %>% select(-contains(c("hvidx", "hml", "hb", "idx", "sh", "ha", "hc", "geometry", "sb")))
...
saveRDS(hh_combined, file= "~/data-mdavis65/steven_sola/3_Survey_Weather/hh_combined_1_86.rds")
...
saveRDS(hh_combined, file= "~/data-mdavis65/steven_sola/3_Survey_Weather/hh_combined_87_172.rds")
...
file1 <- readRDS("~/data-mdavis65/steven_sola/3_Survey_Weather/hh_combined_1_86.rds")
file2 <- readRDS("~/data-mdavis65/steven_sola/3_Survey_Weather/hh_combined_87_172.rds")
